...
import com.example.work.zsproject.view.adapter.PassAdapter;
...
public class PassFragments extends Fragment implements View.OnClickListener {
    ...
    private XRecyclerView mPassXrecycleView;
    ...
    private void initView(View view) {
        ...
        mPassXrecycleView = (XRecyclerView) view.findViewById(R.id.pass_xrecycleView);

        passAdapter = new PassAdapter(getContext());
        list = new ArrayList<>();
    }
    ...
    private void getData() {
        ...
        //设置布局
        mPassXrecycleView.setLayoutManager(new LinearLayoutManager(getContext()));
        //设置适配器
        mPassXrecycleView.setAdapter(passAdapter);
        ...
        mPassXrecycleView.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
            //下拉刷新
            public void onRefresh() {
                Toast.makeText(getContext(),"正在完善此功能...",Toast.LENGTH_LONG).show();
                mPassXrecycleView.refreshComplete();
            }
